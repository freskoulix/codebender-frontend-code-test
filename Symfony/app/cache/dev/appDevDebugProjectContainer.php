...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CodebenderArduinoEditorBundle', 'C:/wamp/www/Symfony/app/Resources/CodebenderArduinoEditorBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CodebenderArduinoEditorBundle', 'C:\\wamp\\www\\Symfony\\src\\Codebender\\ArduinoEditorBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'CodebenderArduinoEditorBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Codebender\\ArduinoEditorBundle/Resources/views', 'CodebenderArduinoEditor');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CodebenderArduinoEditorBundle' => 'Codebender\\ArduinoEditorBundle\\CodebenderArduinoEditorBundle',
            ...
            'assetic.bundles' => array(
                0 => 'CodebenderArduinoEditorBundle',
            ),
            ...
            'assetic.node.bin' => 'C:\\dev\\nodejs\\\\node.EXE',
            'assetic.ruby.bin' => 'C:\\dev\\Ruby200-x64\\bin\\ruby.EXE',
