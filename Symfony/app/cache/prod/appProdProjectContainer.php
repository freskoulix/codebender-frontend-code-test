...
class appProdProjectContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'CodebenderArduinoEditorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
